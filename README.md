...
USBLERST is a lean v1 Rust workspace for an ESP32-S3 USB-HID-to-BLE-gamepad bridge. This milestone provides an on-device bridge demo baseline that exercises the full core pipeline on real hardware.
...
- `crates/usb2ble-platform-espidf`: ESP-IDF-facing platform layer for USB host, BLE HID stubs, NVS, and UART console integration.
